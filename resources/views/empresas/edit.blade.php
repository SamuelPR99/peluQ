            ...
            <div class="w-full max-w-lg p-6 space-y-2 bg-gray-800 bg-opacity-70 rounded-lg shadow-xl z-10">
                ...
                <form action="{{ route('empresas.update', $empresa->id) }}" method="POST" onsubmit="showLoading()">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="hover:border-red-600 hover:ring-red-600 focus:border-red-600 focus:ring-red-600 bg-gray-600 border-gray-600 form-control w-full mt-1 p-2 border rounded" id="nombre_empresa" name="nombre_empresa" value="{{ $empresa->nombre_empresa }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="email" class="block text-gray-300 text-sm">Correo Electrónico</label>
                        <input type="email" class="hover:border-red-600 hover:ring-red-600 focus:border-red-600 focus:ring-red-600 bg-gray-600 border-gray-600 form-control w-full mt-1 p-2 border rounded" id="email" name="email" value="{{ $empresa->email }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="telefono" class="block text-gray-300 text-sm">Teléfono</label>
                        <input type="text" class="hover:border-red-600 hover:ring-red-600 focus:border-red-600 focus:ring-red-600 form-control bg-gray-600 border-gray-600 w-full mt-1 p-2 border rounded" id="telefono" name="telefono" value="{{ $empresa->telefono }}" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="hover:border-red-600 hover:ring-red-600 focus:border-red-600 focus:ring-red-600 form-control bg-gray-600 border-gray-600 w-full mt-1 p-2 border rounded" id="direccion" name="direccion" value="{{ $empresa->direccion }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="codigo_postal" class="block text-gray-300 text-sm">Código Postal</label>
                        <input type="text" class="hover:border-red-600 hover:ring-red-600 focus:border-red-600 focus:ring-red-600 form-control bg-gray-600 border-gray-600 w-full mt-1 p-2 border rounded" id="codigo_postal" name="codigo_postal" value="{{ $empresa->codigo_postal }}" required>
                    </div>
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary bg-white hover:bg-red-500 text-gray-800 font-bold py-2 px-4 rounded transition ease-in-out duration-150">Actualizar Empresa</button>
                    </div>
                </form>
            </div>
        </div>
