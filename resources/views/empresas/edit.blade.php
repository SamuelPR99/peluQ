            ...
            <div class="w-full max-w-lg p-6 space-y-2 bg-gray-800 bg-opacity-70 rounded-lg shadow-xl z-10">
                ...
                <form action="{{ route('empresas.update', $empresa->id) }}" method="POST" onsubmit="showLoading()">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="text-white hover:border-red-600 hover:ring-red-600 focus:border-red-600 focus:ring-red-600 form-control bg-gray-600 border-gray-600 w-full mt-1 p-2 border rounded" id="telefono" name="telefono" value="{{ $empresa->telefono }}" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="text-white hover:border-red-600 hover:ring-red-600 focus:border-red-600 focus:ring-red-600 form-control bg-gray-600 border-gray-600 w-full mt-1 p-2 border rounded" id="direccion" name="direccion" value="{{ $empresa->direccion }}" required>
                    </div>
                    <div class="mb-3">
