        ...
        <div class="backdrop-blur-sm w-full max-w-lg p-6 space-y-2 bg-gray-800 bg-opacity-70 rounded-lg shadow-xl z-10">
            ...
            <form action="{{ route('empresas.store') }}" method="POST" onsubmit="showLoading()">
                ...
                <div class="mb-3 flex items-center">
                    ...
                    <label for="confirmar_subscripcion" class=" accent-red-600 ml-2 text-gray-300 text-sm">Confirmar
                        Subscripción*</label>
                </div>
                <div class="mb-3 flex items-center">
                ...
                <div class="text-center">
                    <button type="submit"
                        class="btn btn-primary bg-white hover:bg-red-500 text-gray-800 font-bold py-2 px-4 rounded transition ease-in-out duration-150">Registrar
                        Empresa</button>
                </div>
            </form>
        </div>
