                    ...
                    <div id="servicios-container">
                        <div class="mb-3 flex space-x-2">
                            ...
                            <div class="w-1/2">
                                ...
                                <input type="number" step="0.01" class="text-white hover:border-red-600 hover:ring-red-600 focus:border-red-600 focus:ring-red-600 form-control bg-gray-600 border-gray-600 w-full mt-1 p-2 border rounded" id="precio" name="servicios[0][precio]" required>
                            </div>
