<div>
    @foreach($valoraciones as $valoracion)
        <div class="p-4 mb-4 bg-gray-100 dark:bg-gray-700 rounded-lg shadow-md">
            <h5 class="font-semibold">{{ $valoracion->cita->servicio->servicio }} {{ __('en la ') }} {{ $valoracion->cita->empresa->nombre_empresa }} {{ __(' - Precio: ') }} {{ $valoracion->cita->servicio->precio }} {{ __('€') }}</h5>
