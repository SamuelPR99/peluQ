<div class="bg-gray-600 p-4 rounded-lg mb-7 text-gray-200 shadow-inner hover:shadow-teal-600 transition-transform ease-in-out accordion">            
    <h4 class="mt-1 mb-2"><strong>{{ __('Citas Programadas') }}</strong>
